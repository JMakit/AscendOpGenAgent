...
| 知识领域 | 关键源码路径 |
|----------|-------------|
| 语言核心 | `triton-ascend/python/triton/language/core.py`, `semantic.py`, `math.py`, `standard.py` |
| 编译器 | `triton-ascend/python/triton/compiler/compiler.py`, `code_generator.py` |
| 运行时 | `triton-ascend/python/triton/runtime/jit.py`, `autotuner.py`, `interpreter.py`, `ascend_interpreter.py` |
| Ascend 扩展 | `triton-ascend/third_party/ascend/language/cann/extension/core.py`, `semantic.py`, `custom_op.py`, `builtin_custom_ops.py` |
| libdevice 数学函数 | `triton-ascend/third_party/ascend/language/cann/libdevice.py`, `__init__.py`, `extension/math_ops.py` |
| Ascend 后端 | `triton-ascend/third_party/ascend/backend/compiler.py`, `driver.py`, `backend_register.py` |
| 自动调优 | `triton-ascend/third_party/ascend/backend/runtime/autotuner.py`, `tile_generator.py` |
| Buffer 模型 | `triton-ascend/python/triton/extension/buffer/language/core.py`, `semantic.py` |
| C++/MLIR | `triton-ascend/include/triton/Dialect/`, `lib/Dialect/`, `lib/Conversion/` |
| Ascend MLIR | `triton-ascend/third_party/ascend/include/Dialect/` |
| 现有文档 | `triton-ascend/docs/zh/` |
