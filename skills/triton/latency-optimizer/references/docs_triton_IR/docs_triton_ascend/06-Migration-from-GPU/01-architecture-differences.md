...
- [architecture_difference.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/migration_guide/architecture_difference.md)
- [migrate_from_gpu.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/migration_guide/migrate_from_gpu.md)
