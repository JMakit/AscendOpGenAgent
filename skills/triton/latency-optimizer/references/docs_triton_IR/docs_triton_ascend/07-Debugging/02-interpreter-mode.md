...
- [interpreter.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/runtime/interpreter.py)
- [ascend_interpreter.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/runtime/ascend_interpreter.py)
- [debugging.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/debug_guide/debugging.md)
