...
- [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py) - PIPE/CORE/MODE/IteratorType 枚举定义
- [semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/semantic.py) - PIPE 枚举的语义层定义
