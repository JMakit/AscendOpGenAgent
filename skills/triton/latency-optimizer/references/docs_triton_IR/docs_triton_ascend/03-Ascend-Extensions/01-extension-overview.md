...
- [__init__.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/__init__.py) - 扩展模块入口，所有 API 的导出定义
- [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py) - 核心枚举与基础操作
