...
- [buffer/core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/extension/buffer/language/core.py) - Buffer 编程模型核心定义（address_space/buffer_type/buffer/alloc/to_buffer/to_tensor/subview）
- [buffer/semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/extension/buffer/language/semantic.py) - Buffer 操作的 IR 生成
- [extension/core.py: ascend_address_space](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L143-L163) - 昇腾地址空间定义
