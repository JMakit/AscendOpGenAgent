...
- [core.py: fixpipe 函数](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L273-L333) - fixpipe 函数定义及对齐校验
- [core.py: FixpipeDMAMode 等枚举](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L247-L270) - DMA 模式、双目的模式、预量化模式、预 ReLU 模式枚举
- [semantic.py: fixpipe 语义](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/semantic.py#L132-L148) - fixpipe 的 IR 生成
