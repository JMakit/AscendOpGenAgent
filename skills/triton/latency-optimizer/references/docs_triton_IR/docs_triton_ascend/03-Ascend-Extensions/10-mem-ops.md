...
- [mem_ops.py: index_put](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/mem_ops.py#L40-L177) - index_put 函数定义
- [mem_ops.py: gather_out_to_ub](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/mem_ops.py#L180-L329) - gather_out_to_ub 函数定义
- [mem_ops.py: scatter_ub_to_out](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/mem_ops.py#L332-L482) - scatter_ub_to_out 函数定义
- [mem_ops.py: index_select_simd](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/mem_ops.py#L485-L636) - index_select_simd 函数定义
- [builtin_custom_ops.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/builtin_custom_ops.py) - 内置自定义算子（SIMT 版本的 index_select/index_put/gather_load/scatter_store）
