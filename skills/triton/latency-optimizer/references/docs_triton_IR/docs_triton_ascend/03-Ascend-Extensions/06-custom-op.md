...
- [custom_op.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/custom_op.py) - 自定义算子注册与调用机制
- [builtin_custom_ops.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/builtin_custom_ops.py) - 内置自定义算子定义
- [core.py: int64](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L93-L101) - int64 类型包装
