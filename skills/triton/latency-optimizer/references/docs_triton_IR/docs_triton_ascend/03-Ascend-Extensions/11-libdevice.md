...
- [libdevice.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/libdevice.py) - libdevice 函数定义（所有 `__hmf_*` 外部函数声明）
- [__init__.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/__init__.py) - 模块初始化（libdevice 与 extension 的整合、math.tanh 覆盖）
- [math_ops.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/math_ops.py) - atan2、isfinited、finitef 定义
- [utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/utils.py) - `triton_enable_libdevice()` 函数定义
