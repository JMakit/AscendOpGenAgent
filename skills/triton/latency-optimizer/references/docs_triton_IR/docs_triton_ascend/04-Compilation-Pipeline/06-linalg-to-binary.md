...
根据硬件平台不同，使用不同的编译函数：
- 910_95 平台：[linalg_to_bin_enable_npu_compile_910_95()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L403)
- A2/A3 平台：[linalg_to_bin_enable_npu_compile_A2_A3()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L607)
- CPU 后端：[linalg_to_llir()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L171) + [llir_to_cpuasm()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L229)
...
[linalg_to_llir()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L171) 用于 CPU 后端，通过 mlir-opt 的标准 Pass 将 Linalg IR 降低为 LLVM IR：
...
[llir_to_cpuasm()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L229) 用于 CPU 后端，将 LLVM IR 编译为 CPU 汇编代码：
...
[linalg_to_bin_enable_npu_compile_910_95()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L403) 的核心流程：
...
[linalg_to_bin_enable_npu_compile_A2_A3()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L607) 与 910_95 类似，但有以下差异：
