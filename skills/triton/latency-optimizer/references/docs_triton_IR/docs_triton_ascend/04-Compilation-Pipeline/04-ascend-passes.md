...
Ascend 特有 Pass 是 Triton-Ascend 编译流水线中针对昇腾 NPU 硬件特性的优化和转换 Pass。这些 Pass 在 TTIR 优化之后、Linalg IR 生成之前执行，由 [ttir_to_linalg()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L95) 函数驱动。
...
[ttir_to_linalg()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L95) 中定义的 Ascend Pass 序列：
...
- 头文件：[AutoBlockify.h](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/include/AutoBlockify/AutoBlockify.h)
- 实现：[AutoBlockify.cpp](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/lib/AutoBlockify/AutoBlockify.cpp)
...
- 头文件：[Passes.h](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/include/TritonAffinityOpt/Passes.h)
- DAG 实现：[DAG.cpp](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/lib/TritonAffinityOpt/DAG.cpp)
- DAGSync：[DAGSync.cpp](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/lib/TritonAffinityOpt/DAGSync.cpp)
- DAGScope：[DAGScope.cpp](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/lib/TritonAffinityOpt/DAGScope.cpp)
- DAGSSBuffer：[DAGSSBuffer.cpp](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/lib/TritonAffinityOpt/DAGSSBuffer.cpp)
