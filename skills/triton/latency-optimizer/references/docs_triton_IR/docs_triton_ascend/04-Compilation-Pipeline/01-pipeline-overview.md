...
编译流水线的阶段注册在 [AscendBackend.add_stages()](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L1058) 中完成：
...
编译入口函数 [compile()](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/compiler/compiler.py#L224) 的核心流程：
