...
源码参考：[utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py#L28-L61)
...
- [programming_guide.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/programming_guide.md) - Tiling 优化章节
- [tile_generator.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/tile_generator.py) - 分块配置生成器
- [utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py) - UB 容量和硬件参数
