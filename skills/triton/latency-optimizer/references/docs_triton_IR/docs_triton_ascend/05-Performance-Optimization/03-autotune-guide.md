...
源码参考：[autotuner.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/autotuner.py#L45-L124)
...
源码参考：[utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py#L98-L105)
...
源码参考：[autoparser.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/autoparser.py)
...
源码参考：[tile_generator.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/tile_generator.py)
...
- [autotuner.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/autotuner.py) - AutoTilingTuner 实现
- [tile_generator.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/tile_generator.py) - 分块配置生成器
- [autoparser.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/autoparser.py) - AST 自动解析器
- [utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py) - 硬件参数和工具函数
