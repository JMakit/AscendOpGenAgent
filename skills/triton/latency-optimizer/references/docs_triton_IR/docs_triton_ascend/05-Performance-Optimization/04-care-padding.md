...
- [core.py - tl.load care_padding 参数](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1621-L1638)
- [semantic.py - load 函数](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1198-L1213)
