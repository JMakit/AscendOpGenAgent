...
源码定义（[core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1151-L1166)）：
...
源码定义（[core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1170-L1178)）：
...
- [core.py - program_id](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1151-L1166) - program_id 函数定义
- [core.py - num_programs](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1170-L1178) - num_programs 函数定义
- [programming_guide.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/programming_guide.md) - Triton 算子开发指南
- [architecture_difference.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/migration_guide/architecture_difference.md) - 架构差异分析
