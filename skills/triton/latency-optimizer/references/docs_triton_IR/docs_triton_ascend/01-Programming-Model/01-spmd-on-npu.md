...
- [migrate_from_gpu.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/migration_guide/migrate_from_gpu.md) - GPU 迁移指南
...
- [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py) - Triton 语言核心定义
