...
源码定义（[core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L288-L293)）：
...
Ascend 后端支持的 FP8 格式（[compiler.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L835)）：
...
源码定义（[semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L46-L58)）：
...
源码定义（[semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L61-L100)）：
...
- [core.py - dtype 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L288-L683) - 数据类型定义和标量类型
- [semantic.py - integer_promote](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L46-L58) - 整数类型提升规则
- [semantic.py - computation_type](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L61-L100) - 计算类型推导规则
- [compiler.py - AscendOptions](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L835) - Ascend 编译选项（FP8 支持）
- [core.py (extension)](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py) - NPU 扩展 API
- [dot.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/triton_api/Linear_Algebra_Ops/dot.md) - tl.dot 支持规格
- [tl.load.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/triton_api/Memory_Pointer_Ops/tl.load.md) - tl.load 支持规格
- [cast.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/triton_api/Creation_Ops/cast.md) - 类型转换支持规格
