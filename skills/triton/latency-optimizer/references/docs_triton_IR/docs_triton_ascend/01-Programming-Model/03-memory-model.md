...
Triton-Ascend 提供了 Buffer 模型扩展 API，允许开发者显式管理片上存储。这些 API 定义在 [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py) 中。
...
A: 对于 shape 为 (2048, 3) 的 Tensor，尾轴 3 会被自动补齐到 32B 对齐，导致性能恶化。可以使用"借轴转置"技巧：将长轴裂出一根对齐轴借给短轴，让两个轴都对齐。参见 [programming_guide.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/programming_guide.md) 中的详细示例。
...
- [00-Architecture](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/00-Architecture/) - 硬件架构概览
...
- [NPUTargetSpec.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HACC/Targets/NPUTargetSpec.td) - NPU 目标规格定义
- [HIVMDMAOps.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMDMAOps.td) - DMA 操作定义
