...
源码参考：[compiler.py - make_ttir](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L72-L93)

### 阶段 3：Ascend Passes (ttir_to_linalg)

这是 Triton-Ascend 编译流程的核心阶段，将 TTIR 转换为 Linalg IR。Pass 执行顺序如下：

源码参考：[compiler.py - ttir_to_linalg](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L95-L168)
...
源码参考：[compiler.py - linalg_to_bin_A2_A3](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L607-L797)
...
源码参考：[compiler.py - linalg_to_bin_910_95](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L403-L604)
...
源码参考：[compiler.py - ttir_to_npubin](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L947-L989)
...
源码参考：[compiler.py - NPUOptions](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L806-L911)
...
- [源码参考 - compiler.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py)：编译器主入口
- [源码参考 - architecture_design_and_core_features.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/architecture_design_and_core_features.md)：架构设计与核心特性
- [源码参考 - triton_ascend.cc](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/triton_ascend.cc)：Ascend Pass 注册
- [源码参考 - utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/utils.py)：编译工具函数
