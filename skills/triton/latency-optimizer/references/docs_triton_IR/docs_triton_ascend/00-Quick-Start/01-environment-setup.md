...
- [源码参考 - installation_guide.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/installation_guide.md)
- [源码参考 - quick_start.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/quick_start.md)
- [源码参考 - get_ascend_devices.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/tools/get_ascend_devices.py)
- [源码参考 - utils.py (架构检测)](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/utils.py)
