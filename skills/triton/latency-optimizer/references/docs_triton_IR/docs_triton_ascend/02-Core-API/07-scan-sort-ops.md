...
- [core.py - associative_scan 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L2150-L2200)
- [core.py - histogram 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L2190-L2200)
- [standard.py - cumsum/cumprod 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/standard.py#L305-L331)
- [standard.py - sort 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/standard.py#L430-L451)
- [semantic.py - associative_scan 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1792-L1809)
- [semantic.py - histogram 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1840-L1843)
