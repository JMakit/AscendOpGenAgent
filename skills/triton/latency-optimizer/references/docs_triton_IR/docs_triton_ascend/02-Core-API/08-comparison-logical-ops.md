...
- [semantic.py - 比较操作实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L552-L643)
- [semantic.py - 按位操作实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L412-L516)
- [semantic.py - 逻辑操作实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L443-L501)
- [semantic.py - 移位操作实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L504-L516)
- [semantic.py - where 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1738)
- [core.py - where 函数定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1886-L1905)
- [core.py - tensor 运算符重载](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L888-L951)
