...
- [math.py - 数学函数定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/math.py)
- [semantic.py - 类型提升规则](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L46-L109)
- [semantic.py - 算术运算实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L219-L352)
- [core.py - _promote_bfloat16_to_float32](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L2100-L2106)
- [standard.py - sigmoid/softmax 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/standard.py#L43-L57)
