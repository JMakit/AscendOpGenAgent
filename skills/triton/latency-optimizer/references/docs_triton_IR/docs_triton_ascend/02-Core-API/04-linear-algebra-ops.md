...
- [core.py - dot 函数定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1518-L1558)
- [core.py - dot_scaled 函数定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1561-L1581)
- [semantic.py - dot 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1559-L1626)
- [semantic.py - dot_scaled 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1659-L1730)
