...
- 源码参考：[custom_op_demo.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/examples/custom_op/custom_op_demo.py)
- 源码参考：[builtin_ops_demo.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/examples/custom_op/builtin_ops_demo.py)
- 源码参考：[custom_op_extra_buffer_demo.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/examples/custom_op/custom_op_extra_buffer_demo.py)
- 源码参考：[custom_op_indexing_map_complex_demo.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/examples/custom_op/custom_op_indexing_map_complex_demo.py)
