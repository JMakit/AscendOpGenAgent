...
- 源码参考：[02-fused-softmax.py (upstream)](file:///d:/项目/trae/triton_a5/triton-ascend/python/tutorials/02-fused-softmax.py)
- 源码参考：[02_fused_softmax_example.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/examples/02_fused_softmax_example.md)
