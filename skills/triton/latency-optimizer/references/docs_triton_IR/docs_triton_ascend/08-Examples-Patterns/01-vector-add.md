...
- 源码参考：[01-vector-add.py (Ascend)](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/tutorials/01-vector-add.py)
- 源码参考：[01-vector-add.py (upstream)](file:///d:/项目/trae/triton_a5/triton-ascend/python/tutorials/01-vector-add.py)
