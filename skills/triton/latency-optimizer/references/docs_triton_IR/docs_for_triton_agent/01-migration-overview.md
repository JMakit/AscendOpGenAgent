...
- [01-architecture-differences.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/01-architecture-differences.md) — GPU vs NPU 架构差异详解
- [02-code-migration-patterns.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/02-code-migration-patterns.md) — 代码迁移模式与 diff 示例
- [03-common-issues.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/03-common-issues.md) — 迁移常见问题 Q&A
- [04-block-pointer-migration.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/04-block-pointer-migration.md) — Block Pointer 迁移注意事项
