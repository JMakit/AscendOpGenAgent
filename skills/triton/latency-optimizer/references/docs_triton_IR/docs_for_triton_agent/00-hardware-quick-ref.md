...
- [01-npu-hardware-overview.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/00-Architecture/01-npu-hardware-overview.md) -- NPU 硬件架构总览（完整型号规格、架构分类详解）
- [02-memory-hierarchy.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/00-Architecture/02-memory-hierarchy.md) -- 内存层次详解（完整数据通路、随路操作、910B ASCII 图）
- [03-pipeline-execution-model.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/00-Architecture/03-pipeline-execution-model.md) -- Pipeline 执行模型（同步机制、Trait 定义、Event ID）
- [04-data-layout.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/00-Architecture/04-data-layout.md) -- 数据布局详解（ND/NZ/zN/nZ/Fractal、布局转换操作）
- [NPUTargetSpec.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HACC/Targets/NPUTargetSpec.td) -- 型号规格 TableGen 源文件
- [HIVMAttrs.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMAttrs.td) -- IR 属性枚举源文件
