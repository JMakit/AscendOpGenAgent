...
> 源码参考：[core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L288-L293) 中 dtype 定义；[compiler.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L835) 中 FP8 支持列表
...
> 源码参考：[semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L61-L100) 中 computation_type 规则；[03-reduction-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/03-reduction-ops.md#L244) 中 bf16 自动提升说明
...
> 源码参考：[04-linear-algebra-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/04-linear-algebra-ops.md)
...
> 源码参考：[08-comparison-logical-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/08-comparison-logical-ops.md#L226-L228) 中 bf16 比较操作说明；[11-libdevice.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/11-libdevice.md#L596-L602) 中 bf16 限制
...
> 源码参考：[core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1621-L1638)
...
> 源码参考：[04-care-padding.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/04-care-padding.md)
...
> 源码参考：[05-faq.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/09-Reference/05-faq.md#L105-L116)
...
> 源码参考：[semantic.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L46-L100) 中 integer_promote 和 computation_type 规则
...
- [数据类型支持矩阵](file:///d:/项目/trae/triton_a5/docs_triton_ascend/09-Reference/02-data-type-matrix.md) - 完整的数据类型支持矩阵
- [数据类型详解](file:///d:/项目/trae/triton_a5/docs_triton_ascend/01-Programming-Model/04-data-types.md) - 数据类型详细规格与对齐要求
- [care_padding 优化](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/04-care-padding.md) - care_padding 参数完整说明
- [归约操作 API](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/03-reduction-ops.md) - 归约操作精度行为
- [线性代数 API](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/04-linear-algebra-ops.md) - tl.dot 精度控制
- [比较与逻辑操作 API](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/08-comparison-logical-ops.md) - bf16 比较操作说明
- [FAQ](file:///d:/项目/trae/triton_a5/docs_triton_ascend/09-Reference/05-faq.md) - 精度相关常见问题
- [优化模式](file:///d:/项目/trae/triton_a5/references/optimization-patterns.md) - 精度保护代码模式
- [API 差异](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/02-api-differences.md) - GPU/NPU API 行为差异
