...
源码参考：[utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py#L41-L50)
...
> **注意**：源码 [utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py#L48-L49) 中 910_95 的 `ub_size_in_kbytes = 256`，这是硬件规格值。编译器实际可用为 248KB（预留 8KB 给编译器内部使用，源码 `UbSize = 2031616; // bits = 248KB, reserve 8KB for compiler`）。
...
- [00-hardware-quick-ref.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/00-hardware-quick-ref.md) -- 910_95 硬件速查手册（UB 容量、核数、对齐要求）
- [01-migration-overview.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/01-migration-overview.md) -- GPU 到 NPU 迁移概览（num_warps/num_stages 移除说明）
- [02-tiling-strategy.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/02-tiling-strategy.md) -- 分块策略详解（存算并行、multiBuffer、对齐要求）
- [tiling-strategies.md](file:///d:/项目/trae/triton_a5/references/tiling-strategies.md) -- Tiling 策略参考（核间/核内切分、典型算子案例）
- [auto_tiling.md](file:///d:/项目/trae/triton_a5/references/auto_tiling.md) -- Autotune 动态选择 Tiling
- [logic_grid_to_phy_grid.md](file:///d:/项目/trae/triton_a5/references/logic_grid_to_phy_grid.md) -- Grid 收缩到物理核数
- [task_single_row_to_multi_rows.md](file:///d:/项目/trae/triton_a5/references/task_single_row_to_multi_rows.md) -- 单行到多行任务优化
- [utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py) -- UB 容量和硬件参数源码
- [programming_guide.md](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/programming_guide.md) -- Triton 算子开发指南
