...
- [01-memory-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/01-memory-ops.md) - tl.load/tl.store 详细说明
- [02-math-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/02-math-ops.md) - 数学运算 API
- [03-reduction-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/03-reduction-ops.md) - 归约操作 API
- [04-linear-algebra-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/04-linear-algebra-ops.md) - tl.dot 详细说明
- [05-atomic-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/05-atomic-ops.md) - 原子操作 API
- [06-shape-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/06-shape-ops.md) - 形状操作 API
- [07-scan-sort-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/07-scan-sort-ops.md) - 扫描与排序操作
- [08-comparison-logical-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/08-comparison-logical-ops.md) - 比较与逻辑操作
- [01-api-support-matrix.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/09-Reference/01-api-support-matrix.md) - API 支持矩阵
- [01-extension-overview.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/01-extension-overview.md) - Ascend 扩展 API 总览
- [03-common-issues.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/03-common-issues.md) - 迁移常见问题
- [04-runtime-errors.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/07-Debugging/04-runtime-errors.md) - 运行时错误排查
- [02-tiling-strategy.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/02-tiling-strategy.md) - 分块策略
- [03-memory-model.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/01-Programming-Model/03-memory-model.md) - NPU 内存层次
- [04-data-types.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/01-Programming-Model/04-data-types.md) - 数据类型支持

### 源码参考

- [core.py - load/store 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1589-L1726)
- [core.py - dot 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1518-L1581)
- [core.py - PropagateNan 枚举](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L24)
- [core.py - maximum/minimum 定义](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1954-L1975)
- [semantic.py - dot 实现](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L1559-L1626)
- [semantic.py - 类型提升规则](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/semantic.py#L46-L109)
- [aux_ops.py - compile_hint 实现](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/aux_ops.py#L114-L151)
- [vec_ops.py - al.sort/al.cast 实现](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/vec_ops.py)
- [compiler.py - min_dot_size](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L68-L69)
