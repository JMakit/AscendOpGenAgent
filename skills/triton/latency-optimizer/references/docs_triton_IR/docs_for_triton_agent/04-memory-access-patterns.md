...
- [variable_modulo.md](file:///d:/项目/trae/triton_a5/references/variable_modulo.md) — 变量取余 → Mask 替代的完整参考
- [load-order.md](file:///d:/项目/trae/triton_a5/references/load-order.md) — Load 指令重排序的完整参考
- [for_loop_add_assignment_operator.md](file:///d:/项目/trae/triton_a5/references/for_loop_add_assignment_operator.md) — 避免循环内 `+=` 更新指针的完整参考
- [constexpr_parameters.md](file:///d:/项目/trae/triton_a5/references/constexpr_parameters.md) — 入参静态化的完整参考
- [00-hardware-quick-ref.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/00-hardware-quick-ref.md) — Ascend910_95 硬件速查手册
