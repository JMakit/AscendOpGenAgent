...
- [auto_tiling.md](file:///d:/项目/trae/triton_a5/references/auto_tiling.md) -- 为固定 Tiling 的算子添加 AutoTune 的完整步骤
- [03-autotune-guide.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/03-autotune-guide.md) -- Autotune 与 AutoTilingTuner 详解
- [03-tiling-and-grid.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/03-tiling-and-grid.md) -- NPU Tiling 与 Grid 配置
- [00-hardware-quick-ref.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/00-hardware-quick-ref.md) -- 910_95 硬件规格速查
- `flash_attention_npu_v8.py` -- Flash Attention NPU 实现及 autotune 配置
- `fused_matmul_npu_v3.py` -- Fused Matmul NPU 实现及 autotune 配置
- [autotuner.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/autotuner.py) -- AutoTilingTuner 源码实现
- [tile_generator.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/tile_generator.py) -- 分块配置生成器源码
