...
- [00-overview.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/04-Synchronization/00-overview.md) - HIVM 同步体系总览
- [01-pipe-sync.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/04-Synchronization/01-pipe-sync.md) - 管道同步操作详解
- [02-block-sync.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/04-Synchronization/02-block-sync.md) - 跨核同步操作详解
- [03-unit-flag.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/04-Synchronization/03-unit-flag.md) - UnitFlag 同步机制
- [04-sync-injection.md](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/04-Synchronization/04-sync-injection.md) - 自动同步注入 Pass
- [04-sync-operations.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/04-sync-operations.md) - Triton 层同步 API
- [HIVMSynchronizationOps.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMSynchronizationOps.td) - 同步操作 TableGen 定义
- [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py) - Triton 同步 API 实现
