...
- [标量降级规避指南](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/06-scalar-degradation-avoidance.md) - where 退化与标量降级的关系
- [内存访问模式优化指南](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/04-memory-access-patterns.md) - 离散访存 vs 连续访存
- [硬件速查手册](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/00-hardware-quick-ref.md) - 910_95 Reg-based 架构差异
- [get_element API 文档](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/triton_api/Extension_Ops/get_element.md) - get_element 参数规格与数据类型支持
- [insert_slice API 文档](file:///d:/项目/trae/triton_a5/triton-ascend/docs/zh/triton_api/Extension_Ops/insert_slice.md) - insert_slice 参数规格与约束
- [Where 条件优化参考文档](file:///d:/项目/trae/triton_a5/references/single_pos_false_where.md) - 原始参考来源
- [vec_ops.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/vec_ops.py) - get_element / insert_slice 实现源码
