...
> 源码参考：[ShouldLowerToScalarLoops.cpp:221-272](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HIVM/IR/ImplByScalarOpInterface/ShouldLowerToScalarLoops.cpp#L221-L272)
...
> 参考文档：[int32_vector_add.md](file:///d:/项目/trae/triton_a5/references/int32_vector_add.md)
...
> 参考文档：[vector_compare.md](file:///d:/项目/trae/triton_a5/references/vector_compare.md)
...
> 参考文档：[single_pos_false_where.md](file:///d:/项目/trae/triton_a5/references/single_pos_false_where.md)
...
910_95 上 argmax/argmin（max_with_index/min_with_index）仅在内存访问对齐不合法时降级。对齐合法性由 [isLegalAccessAlignment](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HIVM/IR/ImplByScalarOpInterface/ShouldLowerToScalarLoops.cpp#L139-L219) 判断：
...
> 源码参考：[Utils.cpp:232-260](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HACC/Utils/Utils.cpp#L232-L260)
...
### 源文档
- [HIVM 向量操作标量降级](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/11-scalar-lowering.md) — 标量降级机制完整文档
- [Int32 向量加法](file:///d:/项目/trae/triton_a5/references/int32_vector_add.md) — i64->i32 转换优化模式
- [Vector Compare](file:///d:/项目/trae/triton_a5/references/vector_compare.md) — 整数比较转 fp32 优化模式

### 编译器源码
- [ShouldLowerToScalarLoops.cpp](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HIVM/IR/ImplByScalarOpInterface/ShouldLowerToScalarLoops.cpp) — 降级判断逻辑核心实现
- [LowerToLoops.cpp](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HIVM/IR/ImplByScalarOpInterface/LowerToLoops.cpp) — 降级实现（scf.for 循环生成）
...
- [Utils.cpp](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HACC/Utils/Utils.cpp) — 架构判定函数（isRegBasedArch/isMemBasedArch/isAscend950）

### HIVM 操作详细文档
- [Binary Ops](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/02-binary-ops.md)（VAddOp, VSubOp, VMulOp, VMinOp, VMaxOp）
- [Compare Ops](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/05-compare-ops.md)（VCmpOp）
- [Reduction Ops](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/07-reduction-ops.md)（VReduceOp）
- [Cumulative Sort](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/09-cumulative-sort.md)（VCumsumOp, VCumprodOp）
- [Special Ops](file:///d:/项目/trae/triton_a5/docs_ascendnpu_ir/01-HIVM-Dialect/02-Vector-Operations/10-special-ops.md)（VMulExtOp）
