...
- [Block Pointer 迁移注意事项（源文档）](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/04-block-pointer-migration.md)
- GPU 版 FlashAttention：`flash_attention.py`
- NPU 版 FlashAttention：`flash_attention_npu_v8.py`
- [内存操作 API](file:///d:/项目/trae/triton_a5/docs_triton_ascend/02-Core-API/01-memory-ops.md)
- [NPU 内存层次](file:///d:/项目/trae/triton_a5/docs_triton_ascend/01-Programming-Model/03-memory-model.md)
- [代码迁移模式](file:///d:/项目/trae/triton_a5/docs_triton_ascend/06-Migration-from-GPU/02-code-migration-patterns.md)
- [编译错误排查](file:///d:/项目/trae/triton_a5/docs_triton_ascend/07-Debugging/03-compile-errors.md)
- [Tiling 策略](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/02-tiling-strategy.md)
- [FAQ](file:///d:/项目/trae/triton_a5/docs_triton_ascend/09-Reference/05-faq.md)
