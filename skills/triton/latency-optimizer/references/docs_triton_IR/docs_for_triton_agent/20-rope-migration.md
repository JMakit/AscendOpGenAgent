...
- [01-migration-overview.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/01-migration-overview.md) — GPU → NPU 迁移概览
- [02-api-differences.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/02-api-differences.md) — API 差异对照
