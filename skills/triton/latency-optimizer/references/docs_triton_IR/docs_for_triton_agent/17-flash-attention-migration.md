...
`enable_mixed_cv` 仅在 910_95（Ascend950）平台上生效。参见 [Config.h](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Tools/bishengir-compile/Config.h#L351-L363)。
...
- [07-compile-params.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/07-compile-params.md) - NPU 编译参数速查
- [05-cv-pipeline-optimization.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/05-cv-pipeline-optimization.md) - CV 流水线优化
- [14-compile-hint-and-extension.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/14-compile-hint-and-extension.md) - compile_hint 与扩展 API 速查
- [09-block-pointer-migration.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/09-block-pointer-migration.md) - Block Pointer 迁移指南
- [02-api-differences.md](file:///d:/项目/trae/triton_a5/docs_for_triton_agent/02-api-differences.md) - GPU/NPU API 差异
...
- [core.py: maximum](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1957) - maximum 函数（含 propagate_nan 参数）
- [standard.py: max](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/standard.py#L174) - max 归约函数（含 propagate_nan 参数）
...
- [compiler.py: NPUOptions](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py#L846) - NPU 编译参数数据类
