...
**定义：** `tl.PropagateNan` 是从 `ir.PROPAGATE_NAN` 导出的枚举类型，定义在 [core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L22)。
...
- [01-extension-overview.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/01-extension-overview.md) - 扩展 API 总览与导入方式
- [02-pipe-and-core.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/02-pipe-and-core.md) - PIPE/CORE/MODE/IteratorType 枚举
- [03-fixpipe.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/03-fixpipe.md) - fixpipe 操作详解
- [04-sync-operations.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/04-sync-operations.md) - 同步操作详解
- [05-sub-vec-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/05-sub-vec-ops.md) - sub_vec_id/sub_vec_num
- [06-custom-op.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/06-custom-op.md) - 自定义算子注册与使用
- [07-buffer-model.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/07-buffer-model.md) - Buffer 编程模型
- [08-aux-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/08-aux-ops.md) - parallel/compile_hint/multibuffer
- [09-vec-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/09-vec-ops.md) - insert_slice/extract_slice/get_element/sort/flip/cast
- [10-mem-ops.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/10-mem-ops.md) - index_put/gather_out_to_ub/scatter_ub_to_out/index_select_simd
- [11-libdevice.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/11-libdevice.md) - libdevice 数学函数库
...
- [aux_ops.py: compile_hint](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/aux_ops.py#L135-L151) - compile_hint 函数定义
- [aux_ops.py: multibuffer](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/aux_ops.py#L153-L162) - multibuffer 函数定义
- [vec_ops.py: insert_slice](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/vec_ops.py#L47-L92) - insert_slice 函数定义
- [vec_ops.py: extract_slice](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/vec_ops.py#L95-L137) - extract_slice 函数定义
- [vec_ops.py: get_element](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/vec_ops.py#L139-L177) - get_element 函数定义
- [core.py: PropagateNan](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L22) - PropagateNan 枚举定义
- [core.py: maximum/minimum](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/core.py#L1935-L1975) - maximum/minimum 函数定义
- [standard.py: max](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/language/standard.py#L174) - max 归约函数定义（含 propagate_nan 参数）
- [core.py: sync_block_set/wait/all](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L202-L244) - 同步操作函数定义
- [core.py: sub_vec_id/sub_vec_num](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/core.py#L166-L171) - sub_vec 操作定义
- [custom_op.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/language/cann/extension/custom_op.py) - 自定义算子注册与调用
- [buffer/core.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/extension/buffer/language/core.py) - Buffer 编程模型核心定义
