...
> 源码参考：[pipe-and-core.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/02-pipe-and-core.md)
...
| 文档 | 路径 | 说明 |
|------|------|------|
| CV 流水线优化参考 | [cv_pipline_opt.md](file:///d:/项目/trae/triton_a5/references/cv_pipline_opt.md) | 优化原理与方法 |
| CV 融合算子详解 | [05-cv-fusion.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/05-cv-fusion.md) | fixpipe/sync_block/sub_vec_id |
| PIPE/CORE 枚举 | [02-pipe-and-core.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/02-pipe-and-core.md) | 硬件流水线与核心类型 |
| fixpipe 操作 | [03-fixpipe.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/03-fixpipe.md) | L0C->UB 数据通路详解 |
