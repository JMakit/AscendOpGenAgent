...
检测逻辑（[get_ascend_devices.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/tools/get_ascend_devices.py)）：
- PCI 设备 ID 包含 `0xd806`
...
- [02-pipe-and-core.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/03-Ascend-Extensions/02-pipe-and-core.md) - PIPE/CORE 枚举详解
- [07-compile-options.md](file:///d:/项目/trae/triton_a5/docs_triton_ascend/04-Compilation-Pipeline/07-compile-options.md) - 编译选项完整参考
- [compiler.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/compiler.py) - NPUOptions 数据类定义
- [get_ascend_devices.py](file:///d:/项目/trae/triton_a5/triton-ascend/python/triton/tools/get_ascend_devices.py) - 910_95 平台检测逻辑
- [runtime/utils.py](file:///d:/项目/trae/triton_a5/triton-ascend/third_party/ascend/backend/runtime/utils.py) - NPU 运行时参数（核心数、UB 大小等）
