...
- [性能分析与瓶颈定位](file:///d:/项目/trae/triton_a5/docs_triton_ascend/05-Performance-Optimization/07-profiling-guide.md)
- [优化模式与代码样例](file:///d:/项目/trae/triton_a5/references/optimization-patterns.md)
