...
HIVM Trait 是附加在操作上的行为约束标记，用于编译器 Pass 中的操作分类和验证。Trait 从 [HIVMTraits.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMTraits.td) 定义。
