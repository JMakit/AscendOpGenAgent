...
来源：[HIVMDMAOps.td:L328-L368](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMDMAOps.td#L328-L368)
...
`hir.nd2nz` 的库函数名会根据下游操作自动调整。如果下游是 `MmadL1Op` 且当前操作提供 per-channel bias，则函数名会添加 `_forbias` 后缀（[HIVMDMAOps.cpp:L660-L671](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/lib/Dialect/HIVM/IR/HIVMDMAOps.cpp#L660-L671)）。
...
- 源码参考：
  ...
  - [dma-ops.mlir](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/test/Dialect/HIVM/IR/dma-ops.mlir) - 测试用例
