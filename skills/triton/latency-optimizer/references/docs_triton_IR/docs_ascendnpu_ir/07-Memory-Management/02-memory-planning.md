...
- **源码参考**：[Passes.td:L130-L161](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/Transforms/Passes.td#L130-L161)
...
从测试用例 [plan-memory.mlir](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/test/Dialect/HIVM/plan-memory.mlir) 可以看到典型的 Inplace 场景：
...
源码参考：[HIVMAttrs.td:L770-L777](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMAttrs.td#L770-L777)
...
- **源码参考**：[Passes.td:L653-L658](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/Transforms/Passes.td#L653-L658)

## 源码参考

- Pass 定义：[Passes.td:L130-L161](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/Transforms/Passes.td#L130-L161)
- MemPlanMode 枚举：[HIVMAttrs.td:L770-L777](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HIVM/IR/HIVMAttrs.td#L770-L777)
- 内存规划测试：[plan-memory.mlir](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/test/Dialect/HIVM/plan-memory.mlir)
