...
| 文件 | 路径 | 说明 |
|------|------|------|
| 方言基类 | [HFusionBase.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionBase.td) | 方言定义与属性枚举 |
| 枚举定义 | [HFusionEnums.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionEnums.td) | 函数属性枚举 |
| 属性定义 | [HFusionAttrs.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionAttrs.td) | 方言属性 |
| 操作定义 | [HFusionOps.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionOps.td) | 非结构化操作 |
| 结构化操作 | [HFusionStructuredOps.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionStructuredOps.td) | 结构化操作 |
| OpDSL 定义 | [HFusionNamedStructuredOps.yaml](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/IR/HFusionNamedStructuredOps.yaml) | YAML 声明式操作定义 |
| 变换 Pass | [Passes.td](file:///d:/项目/trae/triton_a5/AscendNPU-IR/bishengir/include/bishengir/Dialect/HFusion/Transforms/Passes.td) | 变换 Pass 定义 |
